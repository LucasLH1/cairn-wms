...
export const fr = {
  ...
  expectedReceipt: {
    ...
    create: 'Saisir un attendu',
    newTitle: 'Nouvel attendu',
    title: 'Attendu {{number}}',
    number: 'Attendu',
    principal: 'Donneur d’ordre',
    supplier: 'Fournisseur',
    expectedArrivalDate: 'Arrivée prévue',
    lineCount: 'Lignes',
    state: 'État',
    states: { open: 'Ouvert', settled: 'Soldé', cancelled: 'Annulé' },
    lines: 'Lignes de l’attendu',
    item: 'Référence',
    shortLabel: 'Libellé',
    quantity: 'Quantité',
    expectedQuantity: 'Attendu',
    servedQuantity: 'Servi',
    remainingQuantity: 'Solde',
    addLine: 'Ajouter une ligne',
    removeLine: 'Retirer la ligne',
    save: 'Enregistrer l’attendu',
    choose: 'Choisir…',
    none: 'Aucun attendu ouvert sur ce site.',
  },
  session: {
  ...
  refusal: {
    unknownPrincipal: 'Ce donneur d’ordre n’existe pas ou n’est plus actif.',
    unknownSupplier: 'Ce fournisseur n’appartient pas au donneur d’ordre, ou n’est plus actif.',
    unknownItem: 'Une référence n’appartient pas au donneur d’ordre, ou ne peut plus être reçue.',
    duplicateItem: 'Une référence figure sur deux lignes.',
